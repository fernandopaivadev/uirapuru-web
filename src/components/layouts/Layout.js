...
const Layout = ({ history }) => {
    ...
    const [consumerUnitsPopup, setConsumerUnitsPopup] = useState(!getConsumerUnit())
                ...
                <li style={styles.profile} key='profile'>
                    ...
                    {getUser() ?
                        <Menu
                            ...
                            <MenuItem
                                style={{ border: `1px solid ${themes.default.lightGray}` }}
                                onClick={() => {
                            ...
                            <MenuItem
                                style={{ borderBottom: `1px solid ${themes.default.lightGray}` }}
                                onClick={() => {
                                    logout()
                                    history.push('/login')
                                }}
                                        ...
                                        <ListItem
                                            ...
                                            <ListItemText>
                                                ...
                                                <Typography style={styles.address}> {
                                                    `${user?.person?.name.split(' ')[0]
                                                    ??
                                                    user?.company?.tradeName.split(' ')[0]}
                                                    ${user?.person?.name.split(' ')[1]
                                                    ??
                                                    user?.company?.tradeName.split(' ')[1]}`
                                                }
                                                </Typography>
                                            </ListItemText>
                                        </ListItem>
